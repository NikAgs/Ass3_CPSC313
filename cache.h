...
/*
 * Structure used to store a cache set: a cache set contains a
 * dynamically allocated array of pointers to cache lines. The array
 * of pointers is used (instead of an array of lines only) to simplify
 * the reordering of lines in the cache set based on policy (see
 * cache_line_make_mru).
 */
